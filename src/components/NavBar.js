  ...
  return (
        ...
        <nav id='navColor' className="">
          <div className="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div className='inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600' onClick={toggle}>
              <svg
                className='w-8 h-8'
                fill='none'
                stroke='currentColor'
    ...
    /*<nav id='navColor'
      ...
      <div className='blog pr-1 lg:block  hidden activeClassName="text-gray-100 bg-gray-700" text-white'>
        ...
        <Link to='/project' className='block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white' >
          Projects
        </Link>
        <Link to='/post' className='tblock py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white'>
          Blog
        </Link>
        <Link to='/gallery' className='block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white' >
          Gallery
        </Link>
        <Link to='/Contact' className='block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white' >
          Contact
        </Link>
